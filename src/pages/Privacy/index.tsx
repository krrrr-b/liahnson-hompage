...
export default function Privacy(): ReturnType<React.FunctionComponent> {
  ...
  const koreanPrivacy = <><S.TitleWrapper><S.Title>주식회사 이안손앤컴퍼니 개인정보 처리방침</S.Title></S.TitleWrapper><S.DescriptionWrapper>
    <S.Description>
      ...
      <br />
      <br />
      <h2>제 4 조(개인정보의 제 3 자 제공에 관한 사항)</h2><br />
      ...
      <h2>제 5 조(개인정보처리의 위탁에 관한 사항)</h2><br />
      ...
      <h2>제 6 조(개인정보의 파기절차 및 파기방법)</h2><br />
      ...
      사용합니다.<br /><br />
      <h2>제 7 조(정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한 사항)</h2><br />
      ...
      <h2>제 8 조(개인정보의 안전성 확보조치에 관한 사항)</h2><br />
      ...
      보관하고 있습니다.<br /><br />
      <h2>제 9 조(개인정보를 자동으로 수집하는 장치의 설치·운영 및 그 거부에 관한 사항)</h2><br />
      ...
      있습니다.<br /><br />
      <h2>제 10 조(행태정보의 수집·이용·제공 및 거부 등에 관한 사항)</h2><br />
      1. 회사는 온라인 맞춤형 광고 등을 위한 행태정보를 수집·이용·제공하지 않습니다.<br /><br />
      <h2>제 11 조(추가적인 이용·제공 판단기준)</h2><br />
      ...
      <h2>제 12 조 (개인정보 보호책임자에 관한 사항)</h2><br />
      ...
      <h2>제 13 조(개인정보의 열람청구를 접수·처리하는 부서)</h2><br />
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;◼ 담당자 : 윤희석<br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;◼ 연락처 : 02-6731-0701, <a href="mailto:contact@liahnson.com">contact@liahnson.com</a><br /><br />
      <h2>제 16 조(정보주체의 권익침해에 대한 구제방법)</h2><br />
